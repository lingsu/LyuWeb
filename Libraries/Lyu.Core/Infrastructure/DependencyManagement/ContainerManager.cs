...
namespace Lyu.Core.Infrastructure.DependencyManagement
{
    public class ContainerManager
    {
        ...
        public object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new LyuException("Unkown dependency");
            ...
            throw new LyuException("No contructor was found that had all the dependencies satisfied.");
        }
